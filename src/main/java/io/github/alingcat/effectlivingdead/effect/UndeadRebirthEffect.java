...
public class UndeadRebirthEffect extends MobEffect {
    private static final ResourceLocation ICON = new ResourceLocation("effectlivingdead", "textures/mob_effect/undead_rebirth.png");

    public UndeadRebirthEffect() {
